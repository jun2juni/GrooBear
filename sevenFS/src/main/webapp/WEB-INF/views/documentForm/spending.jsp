	...
	<section class="section">
		<div class="container-fluid">
			...
			<div class="col card-body" id="approvalBtn">
				...
				<span><a id="s_eap_stor" href="#"
					class="btn btn-default approvalBtn"
					style="background-color: #00C1F8;">임시저장</a></span> <span><a
					id="s_appLine_btn" href="#" data-bs-toggle="modal"
					data-bs-target="#atrzLineModal"
					class="btn btn-default approvalBtn"
					style="background-color: #F7C800;">결재선 지정</a></span> <span><a
					id="s_cancel_btn" class="btn btn-default approvalBtn"
					style="background-color: #D50100;" href="/approval/home"
