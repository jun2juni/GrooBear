                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-style">
                            ...
                            <form action="/comunity/comunityMonthMenuUpdate" method="post" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <a href="/comunity/comunityMonthMenuDetail?bbsSn=${bbsVO.bbsSn}" class="btn btn-secondary">취소</a>
                                </div>
                            </form>
                        </div>
                    </div>
