        ...
        <div class="card-style mb-4">
		  <!-- 상위탭 시작  -->
	          ...
	          <div class="d-flex justify-content-between align-items-center mb-3">
	            <h3 class="text-dark mt-5" >   </h3>
	            	<button type="button" onclick = "location.href = '/comunity/comunityMonthMenuInsert'" class="btn btn-outline-primary text-nowrap">식단 입력</button>
	          </div>
          <!-- (나머지 게시판 및 테이블 내용) -->
