					...
					<div class=" text-center">
						...
						<div class="d-flex mb-30 mt-3 justify-content-center">
							<div class="content mr-30">
								<input type="hidden" value="${todayWorkTime}" id="todayWorkTime">
						    ...
						    <div class="content">
						    	<input type="hidden" value="${todayWorkEndTime}" id="workEndTime">
						       	<button type="button" id="${workEndButton != null ? '' : 'workEndButton'}" class="btn-sm main-btn danger-btn-light rounded-full btn-hover">퇴근</button>
						  ...
						  <c:forEach var="bbsNoticeList" items="${noticeList}">
					              ...
					              <div>
						  		  <c:if test="${bbsNoticeList.upendFixingYn == 'Y'}">
						  		  		<span class="" style="color:red;">[고정]</span>
								  </c:if>
					              	<a href="/bbs/bbsDetail?bbsSn=${bbsNoticeList.bbsSn}" class="text-black text-bold text-sm">
					              		${bbsNoticeList.bbscttSj}
					              	</a>
					              </div>
					                <span class="text-sm text-gray">
					               		${bbsNoticeList.emplNm} ${bbsNoticeList.bbscttUpdtDt} 
					                </span>
				                 </div>
				                 <hr/>
