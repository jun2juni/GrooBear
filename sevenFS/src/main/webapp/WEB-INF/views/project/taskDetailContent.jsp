...
<div data-task-no="${task.taskNo}">
  <div class="p-3">
    <h5 class="mb-3"><i class="fas fa-tasks me-2 text-primary"></i>업무 상세 정보</h5>
    <table class="table table-bordered table-sm">
      ...
      <h6 class="mt-4"><i class="fas fa-paperclip me-2 text-secondary"></i>첨부 파일</h6>
      <ul class="list-group mt-2">
        <c:forEach var="file" items="${task.attachFileList}">
          <li class="list-group-item d-flex justify-content-between align-items-center">
			...
			<a href="${pageContext.request.contextPath}/file/download?fileName=${file.fileStrePath}"
